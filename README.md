...
This data is stored on my google drive, I kept the original version of this data in order to use it for future reference.
```
...
```
This data are on csv format and contains every record of user's trip data from last 12 months.
